					...
					<div class="nav-flex container">
						...
						<div class="main-nav">
							<ul class="nav_list">
								...
								<li><a name="link" class="button btn-main" href="/book-a-call">Book a Call</a></li>
							</ul>
						</div>
						<div class="hamb">
    	...
    	<footer class="footer">
      	<div class="container">
        	<div class="footer-grid">
             ...
             <a
              	class="social-link"
              	href="https://www.youtube.com/@OuzelCreative"
              	target="_blank"
								rel="external"
            	>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path fill="currentColor" d="M21.593 7.203a2.5 2.5 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.52 2.52 0 0 0 1.767-1.763c.414-1.565.417-4.812.417-4.812s.02-3.265-.407-4.831M9.996 15.005l.005-6 5.207 3.005z"/>
                </svg>
              	<p>YouTube</p>
            	</a>
            	<a
          	...
          	<div class="footer-flex">
            	...
            	<div><a name="link" class="button btn-main" href="/book-a-call">Book a Call</a></div>
          		...
          		<div>
            		<a href="https://business.loveland.org/list/member/ouzel-creative-llc-14008" target="_blank" rel="external">
              		<img
