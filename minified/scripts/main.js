...
`}}customElements.define("header-component",Header);class Footer extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
  <footer class="footer">
    <div class="container">
...
`}}function switchHref(){location.pathname.split("/").length-1>1&&Array.prototype.slice.call(document.getElementsByName("link")).forEach(function(_){let $=_.getAttribute("href");_.setAttribute("href",".."+$)})}customElements.define("footer-component",Footer),switchHref();const hamb=document.querySelector(".hamb"),navMenu=document.querySelector(".main-nav");function mobileMenu(){hamb.classList.toggle("active"),navMenu.classList.toggle("active")}hamb.addEventListener("click",mobileMenu);const navLink=document.querySelectorAll(".nav-link");function closeMenu(){hamb.classList.remove("active"),navMenu.classList.remove("active")}navLink.forEach(_=>_.addEventListener("click",closeMenu)),document.getElementById("copyright-year").innerHTML=new Date().getFullYear();